// 2) In this question, your task is to refactor the code in the main function to remove all variables while preserving the same functionality. Your program should make use of the functions double() and triple() that are defined within the program.
