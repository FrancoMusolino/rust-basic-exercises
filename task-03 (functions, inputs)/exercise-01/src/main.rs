// 1) In this exercise, your task is to define and implement three functions used in the program provided below. The details of each function are as follows:
